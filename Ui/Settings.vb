        ...
        If dgvSettings.Columns(e.ColumnIndex).Name = "Delete" Then
            ...
            If confirm = DialogResult.OK Then
                Try
                    ...
                    CustomAlert.ShowAlert(Me, $"'{key}' deleted successfully.", "Success", CustomAlert.AlertType.Success, CustomAlert.ButtonType.OK)
                    ' Reload grid
                    Await LoadDBSettings()
                Catch ex As Exception
                    CustomAlert.ShowAlert(Me, "Error deleting setting: " & ex.Message, "Error", CustomAlert.AlertType.Error, CustomAlert.ButtonType.OK)
                End Try
            End If
        End If
    End Sub
