    ...
    Public Class ProductRepository
        ...
        Public Function GetAllProducts() As List(Of Product)
            ...
            Using conn As New MySqlConnection(_connString)
                conn.Open()
                Dim sql As String = "SELECT ProductCode, ItemCode, ProductName, Product_Cost_Price, HSCode, ItemTyCd, ItemStdNm, " &
                                    "OrgNatCd, SupplierPacking, ProductUnit, SupplyUnit, Product_VAT_Code, TagPrice, Product_Selling_Price," &
                                    "Product_Wholelsale_Price, Product_Custom_Price1, Product_Custom_Price2, ReOrd_Level, Product_Qty, " &
                                    "IsrcAplcbYn, isActive, CreatedBy, ModifiedBy, SrNo FROM productmaster WHERE isActive = 1"
                    ...
                    Using reader As MySqlDataReader = cmd.ExecuteReader()
                        While reader.Read()
                            products.Add(New Product With {
                                ...
                                .SupplierPackaging = Convert.ToDecimal(reader("SupplierPacking")),
                                ...
                                .ProductQuantity = If(IsDBNull(reader("Product_Qty")), 0D, Convert.ToDecimal(reader("Product_Qty"))),
        ...
        Public Function GetProductByProductCode(itemCd As String) As Product
            ...
            Using conn As New MySqlConnection(_connString)
                ...
                Dim sql As String = "SELECT ProductCode, ItemCode, ProductName, Product_Cost_Price, HSCode, ItemTyCd, ItemStdNm, OrgNatCd," &
                                    ...
                                    "Product_Wholelsale_Price, Product_Custom_Price1, Product_Custom_Price2, ReOrd_Level, isActive, Product_Qty, " &
                                    "IsrcAplcbYn, CreatedBy, ModifiedBy, SrNo FROM productmaster WHERE ProductCode = @itemCd LIMIT 1"
                Using cmd As New MySqlCommand(sql, conn)
